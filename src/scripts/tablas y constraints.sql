create table cliente(id_cliente number, nombre varchar2(50),correo varchar2(50),id_direccion number, telefono number, nif varchar2(50),nombre_comercial varchar2(50));
